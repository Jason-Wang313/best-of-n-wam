...
def audit_ideal_frontier_readiness(root: Path, results_dir: Path | None = None) -> dict[str, Any]:
    ...
    modern_vla_last_attempt = _load_json(results_dir / "modern_vla_libero_policy_eval_last_attempt.json")
    ...
    _signal(
        ...
        (
            ...
            f"last_attempt_present={bool(modern_vla_last_attempt)}, "
            f"last_attempt_verified={modern_vla_last_attempt.get('verified')}, "
            f"last_attempt_horizon={modern_vla_last_attempt.get('horizon')}, "
            f"last_attempt_max_steps={modern_vla_last_attempt.get('max_steps')}, "
