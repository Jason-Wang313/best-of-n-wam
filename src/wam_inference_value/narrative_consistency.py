...
def audit_final_decision(root: Path, results_dir: Path, checks: list[NarrativeCheck]) -> None:
    ...
    add_contains(
        ...
        "final_decision_report",
        text,
        "claim_reference_integrity_command",
        (
    ...
    add_contains(
        ...
        "final_decision_report",
        text,
        "repo_bound_artifact_audit_command",
        (
    ...
    add_contains(
        ...
        "final_decision_report",
        text,
        "report_generation_consistency_command",
        (
            ...
            f"`{report_generation_consistency.get('n_checks')}` generation checks, "
            f"and `{report_generation_consistency.get('n_issues')}` issues"
        ),
    )
