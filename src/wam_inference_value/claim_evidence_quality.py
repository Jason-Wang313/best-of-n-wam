...
def default_claim_source_map() -> dict[int, list[str]]:
    ...
    set_sources(mapping, [113], ["results/experiment_registry.json", "reports/experiment_registry_report.md"])
    set_sources(mapping, [114], ["results/model_artifact_integrity.json", "reports/model_artifact_integrity_report.md"])
    set_sources(mapping, [115], ["results/command_result_consistency.json", "reports/command_result_consistency_report.md"])
    ...
    set_sources(mapping, [120], ["results/evidence_hash_coverage.json", "reports/evidence_hash_coverage_report.md"])
    set_sources(mapping, [121], ["results/repo_bound_artifact_audit.json", "reports/repo_bound_artifact_audit_report.md"])
    set_sources(mapping, [122], ["results/abstract_claim_support.json", "reports/abstract_claim_support_report.md"])
    set_sources(mapping, [123], ["results/publication_scope.json", "reports/publication_scope_report.md"])
