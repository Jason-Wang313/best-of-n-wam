...
if [[ -n "${ROBOCASA_PYTHON:-}" ]]; then
  ...
  "$ROBOCASA_PYTHON" experiments/benchmark_robocasa_multitask_wam.py --output-tag extra4 --env-ids robocasa/PickPlaceCounterToStandMixer robocasa/PickPlaceCounterToToasterOven robocasa/PickPlaceDrawerToCounter robocasa/PickPlaceMicrowaveToCounter --train-states 2 --train-rollouts 8 --val-states 1 --val-rollouts 8 --eval-states 4 --eval-rollouts 8 --horizon 2 --mc-trials 1000 --min-tasks 4 --min-eval-pools 16 --max-exact-mae 0.03
  "$ROBOCASA_PYTHON" experiments/benchmark_robocasa_multitask_wam.py --output-tag family28 --env-ids robocasa/OpenDrawer robocasa/OpenCabinet robocasa/OpenMicrowave robocasa/TurnOnSinkFaucet robocasa/CloseDrawer robocasa/CloseCabinet robocasa/CloseMicrowave robocasa/TurnOffSinkFaucet robocasa/TurnOnStove robocasa/TurnOffStove robocasa/OpenOven robocasa/CloseOven robocasa/OpenDishwasher robocasa/CloseDishwasher robocasa/OpenFridge robocasa/CloseFridge robocasa/OpenFridgeDrawer robocasa/PickPlaceCounterToCabinet robocasa/PickPlaceCounterToDrawer robocasa/PickPlaceCounterToMicrowave robocasa/PickPlaceCounterToSink robocasa/PickPlaceCounterToStove robocasa/PickPlaceCounterToOven robocasa/PickPlaceCounterToBlender robocasa/PickPlaceCounterToStandMixer robocasa/PickPlaceCounterToToasterOven robocasa/PickPlaceDrawerToCounter robocasa/PickPlaceMicrowaveToCounter --train-states 2 --train-rollouts 8 --val-states 1 --val-rollouts 8 --eval-states 2 --eval-rollouts 8 --horizon 2 --mc-trials 1000 --min-tasks 28 --min-eval-pools 56 --max-exact-mae 0.03
  "$ROBOCASA_PYTHON" experiments/benchmark_robocasa_multitask_wam.py --output-tag family32 --env-ids robocasa/OpenDrawer robocasa/OpenCabinet robocasa/OpenMicrowave robocasa/TurnOnSinkFaucet robocasa/CloseDrawer robocasa/CloseCabinet robocasa/CloseMicrowave robocasa/TurnOffSinkFaucet robocasa/TurnOnStove robocasa/TurnOffStove robocasa/OpenOven robocasa/CloseOven robocasa/OpenDishwasher robocasa/CloseDishwasher robocasa/OpenFridge robocasa/CloseFridge robocasa/OpenFridgeDrawer robocasa/PickPlaceCounterToCabinet robocasa/PickPlaceCounterToDrawer robocasa/PickPlaceCounterToMicrowave robocasa/PickPlaceCounterToSink robocasa/PickPlaceCounterToStove robocasa/PickPlaceCounterToOven robocasa/PickPlaceCounterToBlender robocasa/PickPlaceCounterToStandMixer robocasa/PickPlaceCounterToToasterOven robocasa/PickPlaceDrawerToCounter robocasa/PickPlaceMicrowaveToCounter robocasa/CloseFridgeDrawer robocasa/TurnOnBlender robocasa/PickPlaceCabinetToCounter robocasa/PickPlaceSinkToCounter --train-states 2 --train-rollouts 8 --val-states 1 --val-rollouts 8 --eval-states 2 --eval-rollouts 8 --horizon 2 --mc-trials 1000 --min-tasks 32 --min-eval-pools 64 --max-exact-mae 0.03
  "$ROBOCASA_PYTHON" experiments/benchmark_robocasa_micro_rollout_probe.py --output-tag stratified_probe --env-ids robocasa/CleanMicrowave robocasa/ClearSink robocasa/ClearCuttingBoard robocasa/RinseCuttingBoard robocasa/RinseSinkBasin robocasa/WashFruitColander robocasa/WashLettuce robocasa/CollectWashingSupplies robocasa/MicrowavePressButton robocasa/PreheatOven robocasa/SlideOvenRack robocasa/SlideToasterOvenRack robocasa/ToastBagel robocasa/AdjustHeat robocasa/LowerHeat robocasa/TransportCookware robocasa/FillKettle robocasa/FillBlenderJug robocasa/LoadDishwasher robocasa/EmptyDishRack robocasa/LoadFridgeByType robocasa/ArrangeDrinkware robocasa/GatherVegetables robocasa/OrganizeCondiments robocasa/TurnOnMicrowave robocasa/TurnOnToaster robocasa/TurnOnToasterOven robocasa/TurnOnElectricKettle --rollouts 2 --horizon 1 --min-tasks 1
  "$ROBOCASA_PYTHON" experiments/benchmark_robocasa_multitask_wam.py --output-tag stratified55 --env-ids robocasa/OpenDrawer robocasa/OpenCabinet robocasa/OpenMicrowave robocasa/TurnOnSinkFaucet robocasa/CloseDrawer robocasa/CloseCabinet robocasa/CloseMicrowave robocasa/TurnOffSinkFaucet robocasa/TurnOnStove robocasa/TurnOffStove robocasa/OpenOven robocasa/CloseOven robocasa/OpenDishwasher robocasa/CloseDishwasher robocasa/OpenFridge robocasa/CloseFridge robocasa/OpenFridgeDrawer robocasa/PickPlaceCounterToCabinet robocasa/PickPlaceCounterToDrawer robocasa/PickPlaceCounterToMicrowave robocasa/PickPlaceCounterToSink robocasa/PickPlaceCounterToStove robocasa/PickPlaceCounterToOven robocasa/PickPlaceCounterToBlender robocasa/PickPlaceCounterToStandMixer robocasa/PickPlaceCounterToToasterOven robocasa/PickPlaceDrawerToCounter robocasa/PickPlaceMicrowaveToCounter robocasa/CloseFridgeDrawer robocasa/TurnOnBlender robocasa/PickPlaceCabinetToCounter robocasa/PickPlaceSinkToCounter robocasa/CleanMicrowave robocasa/ClearSink robocasa/ClearCuttingBoard robocasa/RinseCuttingBoard robocasa/RinseSinkBasin robocasa/WashFruitColander robocasa/WashLettuce robocasa/CollectWashingSupplies robocasa/MicrowavePressButton robocasa/ToastBagel robocasa/AdjustHeat robocasa/LowerHeat robocasa/TransportCookware robocasa/FillKettle robocasa/FillBlenderJug robocasa/LoadDishwasher robocasa/EmptyDishRack robocasa/LoadFridgeByType robocasa/ArrangeDrinkware robocasa/GatherVegetables robocasa/OrganizeCondiments robocasa/TurnOnMicrowave robocasa/TurnOnToaster --train-states 2 --train-rollouts 8 --val-states 1 --val-rollouts 8 --eval-states 2 --eval-rollouts 8 --horizon 2 --mc-trials 1000 --min-tasks 55 --min-eval-pools 110 --max-exact-mae 0.03
  ROBOCASA_FRONTIER_IDS=(
    robocasa/ManipulateSinkFaucet robocasa/ManipulateStoveKnob robocasa/MoveFreezerToFridge robocasa/MoveFridgeToFreezer robocasa/MoveToCounter robocasa/MoveToFreezerDrawer
    robocasa/PickPlaceCoffee robocasa/PickPlaceFridgeDrawerToShelf robocasa/PickPlaceFridgeShelfToDrawer robocasa/PickPlaceStoveToCounter robocasa/PickPlaceToasterOvenToCounter robocasa/PickPlaceToasterToCounter
    robocasa/AirDryFruit robocasa/CleanBlenderJug robocasa/ClearClutter robocasa/ClearFoodWaste robocasa/CountertopCleanup robocasa/FoodCleanup robocasa/GatherProduceWashing
    robocasa/RinseBowls robocasa/RinseFragileItem robocasa/WashFish robocasa/WashInSaucepan robocasa/GetToastedBread robocasa/HeatMug robocasa/KettleBoiling
    robocasa/MicrowaveCorrectMeal robocasa/PlaceMicrowaveSafeItem robocasa/PrepareToast robocasa/ReturnHeatedFood robocasa/ToastBaguette robocasa/TurnOffMicrowave
    robocasa/AddIceCubes robocasa/ArrangeVegetables robocasa/BlendIngredients robocasa/CoffeeSetupMug robocasa/DrainVeggies robocasa/ArrangeTea robocasa/CondimentCollection
    robocasa/BreadAndCheese robocasa/CerealAndBowl robocasa/AddToSoupPot
  )
  "$ROBOCASA_PYTHON" experiments/benchmark_robocasa_micro_rollout_probe.py --output-tag frontier_probe --env-ids "${ROBOCASA_FRONTIER_IDS[@]}" --rollouts 2 --horizon 1 --min-tasks 1
  ROBOCASA_STRATIFIED97_IDS=(
    robocasa/OpenDrawer robocasa/OpenCabinet robocasa/OpenMicrowave robocasa/TurnOnSinkFaucet robocasa/CloseDrawer robocasa/CloseCabinet robocasa/CloseMicrowave robocasa/TurnOffSinkFaucet
    robocasa/TurnOnStove robocasa/TurnOffStove robocasa/OpenOven robocasa/CloseOven robocasa/OpenDishwasher robocasa/CloseDishwasher robocasa/OpenFridge robocasa/CloseFridge robocasa/OpenFridgeDrawer
    robocasa/PickPlaceCounterToCabinet robocasa/PickPlaceCounterToDrawer robocasa/PickPlaceCounterToMicrowave robocasa/PickPlaceCounterToSink robocasa/PickPlaceCounterToStove robocasa/PickPlaceCounterToOven robocasa/PickPlaceCounterToBlender
    robocasa/PickPlaceCounterToStandMixer robocasa/PickPlaceCounterToToasterOven robocasa/PickPlaceDrawerToCounter robocasa/PickPlaceMicrowaveToCounter robocasa/CloseFridgeDrawer robocasa/TurnOnBlender robocasa/PickPlaceCabinetToCounter robocasa/PickPlaceSinkToCounter
    robocasa/CleanMicrowave robocasa/ClearSink robocasa/ClearCuttingBoard robocasa/RinseCuttingBoard robocasa/RinseSinkBasin robocasa/WashFruitColander robocasa/WashLettuce robocasa/CollectWashingSupplies
    robocasa/MicrowavePressButton robocasa/ToastBagel robocasa/AdjustHeat robocasa/LowerHeat robocasa/TransportCookware robocasa/FillKettle robocasa/FillBlenderJug robocasa/LoadDishwasher
    robocasa/EmptyDishRack robocasa/LoadFridgeByType robocasa/ArrangeDrinkware robocasa/GatherVegetables robocasa/OrganizeCondiments robocasa/TurnOnMicrowave robocasa/TurnOnToaster
    "${ROBOCASA_FRONTIER_IDS[@]}"
  )
