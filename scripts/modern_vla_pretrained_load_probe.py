...
def _run_child(python_path: Path, libero_source: Path, libero_config: Path, timeout_s: int) -> dict[str, Any]:
    env = os.environ.copy()
...
def run(args: argparse.Namespace) -> dict[str, Any]:
    ...
    child = _run_child(python_path, libero_source, libero_config, args.timeout_s)
