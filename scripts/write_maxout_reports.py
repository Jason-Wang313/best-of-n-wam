...
- RoboCasa micro-rollout probe: extra task IDs `{robocasa_micro.get('nondegenerate_env_ids')}` reset and produced short nondegenerate rollouts. This is lower-tier viability evidence, not learned-WAM validation.
