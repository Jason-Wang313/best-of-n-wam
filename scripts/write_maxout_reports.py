...
- ManiSkill dependency probe: Pinocchio import `{maniskill_dependency_probe.get('pinocchio_import_available')}`; robotics API `{maniskill_dependency_probe.get('pinocchio_api_available')}`; binary PyPI `pinocchio` wheel `{maniskill_dependency_probe.get('pypi_pinocchio_binary_wheel_available')}`; binary `pin` wheel `{maniskill_dependency_probe.get('pin_binary_wheel_available')}`; source install attempted `{maniskill_dependency_probe.get('source_install_attempted')}`.
...
- `{maniskill_dependency_command}`: passed as a blocker probe; Pinocchio import `{maniskill_dependency_probe.get('pinocchio_import_available')}`, robotics API `{maniskill_dependency_probe.get('pinocchio_api_available')}`, binary PyPI `pinocchio` wheel `{maniskill_dependency_probe.get('pypi_pinocchio_binary_wheel_available')}`, binary `pin` wheel `{maniskill_dependency_probe.get('pin_binary_wheel_available')}`, source install attempted `{maniskill_dependency_probe.get('source_install_attempted')}`.
