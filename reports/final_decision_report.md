...
- `python scripts/artifact_manifest.py --fail-on-error`: passed with `450` scientific artifacts, `77226188` bytes, `15` manifest checks, and `0` issues.
...
- `python scripts/source_manifest.py --fail-on-error`: passed with `246` source files, `1810072` bytes, `14` source-manifest checks, and `0` issues.
