...
- `python -m pytest -q`: passed with `169 passed`.
- `python scripts/test_inventory.py --fail-on-error`: passed with `169` collected tests, `6` inventory checks, and `0` issues.
...
- `python scripts/artifact_manifest.py --fail-on-error`: passed with `436` scientific artifacts, `73700370` bytes, `15` manifest checks, and `0` issues.
...
- `python scripts/source_manifest.py --fail-on-error`: passed with `233` source files, `1673378` bytes, `14` source-manifest checks, and `0` issues.
