...
- `python scripts/test_inventory.py --fail-on-error`: passed with `146` collected tests, `6` inventory checks, and `0` issues.
...
- `python scripts/source_manifest.py --fail-on-error`: passed with `221` source files, `1582791` bytes, `14` source-manifest checks, and `0` issues.
