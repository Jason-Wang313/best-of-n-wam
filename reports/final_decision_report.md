...
- `python scripts/artifact_manifest.py --fail-on-error`: passed with `412` scientific artifacts, `63117370` bytes, `15` manifest checks, and `0` issues.
...
- `python scripts/source_manifest.py --fail-on-error`: passed with `223` source files, `1603503` bytes, `14` source-manifest checks, and `0` issues.
