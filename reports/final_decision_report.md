...
- `bash scripts/run_visual_optional.sh`: passed; toy visual MAE `0.0185`; Reacher RGB WAM utility corr `0.2199`, utility MAE `0.5208`, visual-random N32 CI lower `0.1998`; Fetch RGB WAM mean corr `0.7325`, visual-random N32 CI lower `0.3475`.
...
- `python scripts/claims_status.py`: passed with `69` verified, `0` partial, `0` unsupported, `0` failed, and `0` README/paper overclaims.
