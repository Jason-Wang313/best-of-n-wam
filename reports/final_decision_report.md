...
- `python -m pytest -q`: passed with `161 passed`.
- `python scripts/test_inventory.py --fail-on-error`: passed with `161` collected tests, `6` inventory checks, and `0` issues.
...
- `python scripts/artifact_integrity.py --fail-on-error`: passed with `723` artifact references checked and `0` issues.
- `python scripts/artifact_manifest.py --fail-on-error`: passed with `434` scientific artifacts, `73692664` bytes, `15` manifest checks, and `0` issues.
...
- `python scripts/table_schema.py --fail-on-error`: passed with `226` tables, `213292` rows, `17` schema checks, and `0` issues.
- `python scripts/source_manifest.py --fail-on-error`: passed with `227` source files, `1646506` bytes, `14` source-manifest checks, and `0` issues.
...
- `python scripts/model_artifact_integrity.py --fail-on-error`: passed with `52` model artifacts, `387` NPZ arrays, `13` joblib predictors, `10` model-artifact checks, and `0` issues.
...
- `python scripts/tracked_artifact_provenance.py --fail-on-error`: passed with `119` claim sources, `467` artifact references, and `0` issues.
...
- `python scripts/evidence_hash_coverage.py --fail-on-error`: passed with `117` claim sources, `465` artifact references, `582` hashed records, and `0` issues.
