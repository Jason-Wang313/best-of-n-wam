...
- `python -m pytest -q`: passed with `159 passed`.
- `python scripts/test_inventory.py --fail-on-error`: passed with `159` collected tests, `6` inventory checks, and `0` issues.
...
- `python scripts/artifact_integrity.py --fail-on-error`: passed with `717` artifact references checked and `0` issues.
- `python scripts/artifact_manifest.py --fail-on-error`: passed with `423` scientific artifacts, `69788124` bytes, `15` manifest checks, and `0` issues.
...
- `python scripts/table_schema.py --fail-on-error`: passed with `222` tables, `212891` rows, `17` schema checks, and `0` issues.
- `python scripts/source_manifest.py --fail-on-error`: passed with `224` source files, `1628356` bytes, `14` source-manifest checks, and `0` issues.
...
- `python scripts/tracked_artifact_provenance.py --fail-on-error`: passed with `119` claim sources, `461` artifact references, and `0` issues.
...
- `python scripts/evidence_hash_coverage.py --fail-on-error`: passed with `117` claim sources, `459` artifact references, `576` hashed records, and `0` issues.
