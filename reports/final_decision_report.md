...
- `python scripts/artifact_manifest.py --fail-on-error`: passed with `405` scientific artifacts, `57224139` bytes, `15` manifest checks, and `0` issues.
...
- `python scripts/source_manifest.py --fail-on-error`: passed with `223` source files, `1591222` bytes, `14` source-manifest checks, and `0` issues.
