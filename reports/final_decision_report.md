...
- `python scripts/test_inventory.py --fail-on-error`: passed with `142` collected tests, `6` inventory checks, and `0` issues.
...
- `python scripts/artifact_manifest.py --fail-on-error`: passed with `400` scientific artifacts, `56471656` bytes, `15` manifest checks, and `0` issues.
...
- `python scripts/source_manifest.py --fail-on-error`: passed with `218` source files, `1552717` bytes, `14` source-manifest checks, and `0` issues.
