...
- `python scripts/test_inventory.py --fail-on-error`: passed with `145` collected tests, `6` inventory checks, and `0` issues.
...
- `python scripts/artifact_manifest.py --fail-on-error`: passed with `402` scientific artifacts, `56480677` bytes, `15` manifest checks, and `0` issues.
...
- `python scripts/source_manifest.py --fail-on-error`: passed with `221` source files, `1576293` bytes, `14` source-manifest checks, and `0` issues.
