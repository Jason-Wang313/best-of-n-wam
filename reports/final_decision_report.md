...
- `python -m pytest -q`: passed with `127 passed`.
- `python scripts/test_inventory.py --fail-on-error`: passed with `127` collected tests, `6` inventory checks, and `0` issues.
...
- `python scripts/artifact_manifest.py --fail-on-error`: passed with `398` scientific artifacts, `56499147` bytes, `15` manifest checks, and `0` issues.
...
- `python scripts/source_manifest.py --fail-on-error`: passed with `206` source files, `1448281` bytes, `14` source-manifest checks, and `0` issues.
