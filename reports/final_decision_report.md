...
- `python -m pytest -q`: passed with `141 passed`.
- `python scripts/test_inventory.py --fail-on-error`: passed with `141` collected tests, `6` inventory checks, and `0` issues.
...
- `python scripts/artifact_manifest.py --fail-on-error`: passed with `399` scientific artifacts, `56445757` bytes, `15` manifest checks, and `0` issues.
...
- `python scripts/source_manifest.py --fail-on-error`: passed with `215` source files, `1527264` bytes, `14` source-manifest checks, and `0` issues.
