...
- `python -m pytest -q`: passed with `182 passed`.
- `python scripts/test_inventory.py --fail-on-error`: passed with `182` collected tests, `6` inventory checks, and `0` issues.
...
- `python scripts/artifact_manifest.py --fail-on-error`: passed with `443` scientific artifacts, `77219291` bytes, `15` manifest checks, and `0` issues.
...
- `python scripts/source_manifest.py --fail-on-error`: passed with `243` source files, `1745768` bytes, `14` source-manifest checks, and `0` issues.
