...
- `python scripts/artifact_manifest.py --fail-on-error`: passed with `412` scientific artifacts, `63117647` bytes, `15` manifest checks, and `0` issues.
...
- `python scripts/source_manifest.py --fail-on-error`: passed with `223` source files, `1608949` bytes, `14` source-manifest checks, and `0` issues.
