...
- `python scripts/source_manifest.py --fail-on-error`: passed with `209` source files, `1474601` bytes, `14` source-manifest checks, and `0` issues.
...
- `python scripts/claim_semantics.py --fail-on-error`: passed with `127` claims, `175` semantic checks, `53` CI-backed claims, and `0` issues.
