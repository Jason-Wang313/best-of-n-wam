...
- `python -m pytest -q`: passed with `179 passed`.
- `python scripts/test_inventory.py --fail-on-error`: passed with `179` collected tests, `6` inventory checks, and `0` issues.
...
- `python scripts/artifact_integrity.py --fail-on-error`: passed with `728` artifact references checked and `0` issues.
- `python scripts/artifact_manifest.py --fail-on-error`: passed with `442` scientific artifacts, `77201968` bytes, `15` manifest checks, and `0` issues.
...
- `python scripts/source_manifest.py --fail-on-error`: passed with `240` source files, `1722272` bytes, `14` source-manifest checks, and `0` issues.
...
- `python scripts/tracked_artifact_provenance.py --fail-on-error`: passed with `119` claim sources, `469` artifact references, and `0` issues.
...
- `python scripts/evidence_hash_coverage.py --fail-on-error`: passed with `117` claim sources, `467` artifact references, `584` hashed records, and `0` issues.
