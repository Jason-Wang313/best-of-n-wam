...
- `python scripts/repo_bound_artifact_audit.py --fail-on-error`: passed with `912` records, `175` claim sources, `737` artifact references, `0` outside-repo records, `0` missing records, and `0` issues.
