...
- `python scripts/artifact_integrity.py --fail-on-error`: passed with `722` artifact references checked and `0` issues.
- `python scripts/artifact_manifest.py --fail-on-error`: passed with `431` scientific artifacts, `69852815` bytes, `15` manifest checks, and `0` issues.
...
- `python scripts/table_schema.py --fail-on-error`: passed with `225` tables, `213289` rows, `17` schema checks, and `0` issues.
...
- `python scripts/tracked_artifact_provenance.py --fail-on-error`: passed with `119` claim sources, `466` artifact references, and `0` issues.
...
- `python scripts/evidence_hash_coverage.py --fail-on-error`: passed with `117` claim sources, `464` artifact references, `581` hashed records, and `0` issues.
