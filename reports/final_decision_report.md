...
- `python -m pytest -q`: passed with `172 passed`.
- `python scripts/test_inventory.py --fail-on-error`: passed with `172` collected tests, `6` inventory checks, and `0` issues.
...
- `python scripts/artifact_manifest.py --fail-on-error`: passed with `437` scientific artifacts, `73702915` bytes, `15` manifest checks, and `0` issues.
...
- `python scripts/source_manifest.py --fail-on-error`: passed with `236` source files, `1683754` bytes, `14` source-manifest checks, and `0` issues.
