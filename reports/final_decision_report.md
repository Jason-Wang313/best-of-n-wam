...
- `python scripts/artifact_integrity.py --fail-on-error`: passed with `689` artifact references checked and `0` issues.
...
- `python scripts/tracked_artifact_provenance.py --fail-on-error`: passed with `115` claim sources, `445` artifact references, and `0` issues.
- `python scripts/repo_bound_artifact_audit.py --fail-on-error`: passed with `860` records, `171` claim sources, `689` artifact references, `0` outside-repo records, `0` missing records, and `0` issues.
...
- `python scripts/evidence_hash_coverage.py --fail-on-error`: passed with `113` claim sources, `443` artifact references, `556` hashed records, and `0` issues.
