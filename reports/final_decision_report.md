...
- `python scripts/test_inventory.py --fail-on-error`: passed with `149` collected tests, `6` inventory checks, and `0` issues.
...
- `python scripts/artifact_manifest.py --fail-on-error`: passed with `412` scientific artifacts, `59524729` bytes, `15` manifest checks, and `0` issues.
...
- `python scripts/source_manifest.py --fail-on-error`: passed with `223` source files, `1595794` bytes, `14` source-manifest checks, and `0` issues.
