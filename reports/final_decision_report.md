...
- `python -m pytest -q`: passed with `160 passed`.
- `python scripts/test_inventory.py --fail-on-error`: passed with `160` collected tests, `6` inventory checks, and `0` issues.
...
- `python scripts/artifact_integrity.py --fail-on-error`: passed with `721` artifact references checked and `0` issues.
- `python scripts/artifact_manifest.py --fail-on-error`: passed with `429` scientific artifacts, `69792301` bytes, `15` manifest checks, and `0` issues.
...
- `python scripts/table_schema.py --fail-on-error`: passed with `224` tables, `212893` rows, `17` schema checks, and `0` issues.
- `python scripts/source_manifest.py --fail-on-error`: passed with `224` source files, `1632308` bytes, `14` source-manifest checks, and `0` issues.
...
- `python scripts/model_artifact_integrity.py --fail-on-error`: passed with `51` model artifacts, `363` NPZ arrays, `13` joblib predictors, `10` model-artifact checks, and `0` issues.
...
- `python scripts/tracked_artifact_provenance.py --fail-on-error`: passed with `119` claim sources, `465` artifact references, and `0` issues.
...
- `python scripts/evidence_hash_coverage.py --fail-on-error`: passed with `117` claim sources, `463` artifact references, `580` hashed records, and `0` issues.
