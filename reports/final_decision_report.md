...
- `python -m pytest -q`: passed with `164 passed`.
- `python scripts/test_inventory.py --fail-on-error`: passed with `164` collected tests, `6` inventory checks, and `0` issues.
...
- `python scripts/artifact_manifest.py --fail-on-error`: passed with `435` scientific artifacts, `73697819` bytes, `15` manifest checks, and `0` issues.
...
- `python scripts/source_manifest.py --fail-on-error`: passed with `230` source files, `1659763` bytes, `14` source-manifest checks, and `0` issues.
