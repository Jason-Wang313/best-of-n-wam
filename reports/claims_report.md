...
- 40. Benchmark visual optional. Evidence: verified=True, frame_std=24.34952509299029
...
- 49. ManiSkill rollout pools collected. Evidence: pools=30, rollouts=32, rows=900
- 50. ManiSkill exact law verified. Evidence: utility MAE=0.0034490668019852445, exact rows=180
...
- 52. ManiSkill WAM-lite trained and evaluated. Evidence: model metric rows=6, table rows=6
- 53. ManiSkill closed-loop learned scorer beats random. Evidence: learned-random closed-loop CI={'n': 5, 'mean': 0.027762312500152514, 'std': 0.020055963136210424, 'stderr': 0.008969299385359276, 'ci95': 0.01757982679530418, 'lo': 0.010182485704848334, 'hi': 0.04534213929545669}, rows=90
- 54. ManiSkill learned open-loop scorer is honestly reported. Evidence: learned-random open-loop CI={'n': 5, 'mean': -0.005754620067846242, 'std': 0.04861601605708501, 'stderr': 0.021741743339772673, 'ci95': 0.04261381694595444, 'lo': -0.04836843701380068, 'hi': 0.036859196878108194}, rows=900
...
- 56. Benchmark RGB visual WAM exact law verified. Evidence: utility MAE=0.01571480996432407, exact rows=150
- 57. Benchmark RGB visual WAM scorer beats random with CI. Evidence: visual-random CI={'n': 5, 'mean': 0.2367775727718704, 'std': 0.04220964852617569, 'stderr': 0.01887672868218053, 'ci95': 0.03699838821707384, 'lo': 0.19977918455479654, 'hi': 0.27377596098894424}, rows=750
- 58. Benchmark RGB visual WAM oracle gap reported. Evidence: oracle-visual CI={'n': 5, 'mean': 0.3433881226502652, 'std': 0.09104423341118655, 'stderr': 0.04071621897335413, 'ci95': 0.0798037891877741, 'lo': 0.2635843334624911, 'hi': 0.4231919118380393}, rows=750
- 59. Gymnasium Robotics Fetch benchmark suite verified. Evidence: envs=['FetchReach-v4', 'FetchPush-v4', 'FetchPickAndPlace-v4'], pools=60, rows=1800
- 60. Gymnasium Robotics Fetch exact law verified. Evidence: utility MAE=0.012637772476737578, exact rows=360
...
- 62. Gymnasium Robotics closed-loop learned scorer beats random. Evidence: closed-loop learned-random CI={'n': 5, 'mean': 0.7086378606835364, 'std': 0.5149831233310606, 'stderr': 0.23030745420668186, 'ci95': 0.4514026102450964, 'lo': 0.25723525043844, 'hi': 1.160040470928633}, rows=135
...
- 64. Gymnasium Robotics RGB visual WAM trained and evaluated. Evidence: envs=['FetchReach-v4', 'FetchPush-v4', 'FetchPickAndPlace-v4'], mean corr=0.7325062733110719, rows=1350
...
- 73. RoboSuite Panda manipulation benchmark suite verified. Evidence: envs=['Lift', 'Stack', 'Door'], pools=30, rows=1260
- 74. RoboSuite exact law verified. Evidence: utility MAE=0.0023698818100493587, exact rows=180
...
- 86. LIBERO sparse-success scripted policy smoke verified. Evidence: episodes=50, successes=50, rows=50, success CI={'n': 50, 'mean': 1.0, 'lo': 1.0, 'hi': 1.0, 'std': 0.0}
- 87. LIBERO learned action-head sparse-success smoke verified. Evidence: tasks=['libero_object/0', 'libero_object/1', 'libero_object/2', 'libero_object/3', 'libero_object/4', 'libero_object/5', 'libero_object/6', 'libero_object/7', 'libero_object/8', 'libero_object/9'], eval=30/30, rows=50, success CI={'n': 30, 'mean': 1.0, 'lo': 1.0, 'hi': 1.0, 'std': 0.0}
- 88. LIBERO time-conditioned autonomous low-dimensional BC sparse-success smoke verified. Evidence: tasks=['libero_object/0', 'libero_object/1', 'libero_object/2', 'libero_object/3', 'libero_object/4', 'libero_object/5', 'libero_object/6', 'libero_object/7', 'libero_object/8', 'libero_object/9'], train=12535, eval=50/50, rows=100, success CI={'n': 50, 'mean': 1.0, 'lo': 1.0, 'hi': 1.0, 'std': 0.0}, policy={'type': 'low_dim_knn_behavior_cloning', 'uses_phase_index': False, 'uses_target_point_command': False, 'uses_task_id': True, 'uses_previous_action': True, 'uses_step_clock': True, 'knn_k': 3, 'knn_temperature': 0.05}
