...
- `modern_vla_libero`: ready_to_promote=`False`; missing=['heldout_sparse_success_modern_vla_eval']
  ...
  - heldout_sparse_success_modern_vla_eval: `False` (eval_verified=False, heldout_eval=False, eval_episodes=0, n_eval_seeds=5, max_steps=1, eval_successes=0, success_rate=None, success_ci={'n': 0, 'mean': None, 'lo': None, 'hi': None}; one_step_verified=True, one_step_success=False)
