...
- `full_robocasa_wide`: ready_to_promote=`False`; missing=['full_registry_rollout_pool_coverage', 'full_registry_any_artifact_coverage', 'all_categories_fully_covered']
  ...
  - full_registry_any_artifact_coverage: `False` (any_artifact_covered=136/396; residual_attempts=6, residual_candidates=12, residual_timeouts=11, residual_nondegenerate=0, residual_categories=['cleaning', 'close', 'long_horizon_or_compositional', 'manipulate', 'turn'], residual_artifacts=['benchmark_robocasa_residual_frontier_sweep_cleaning_gap_probe.json', 'benchmark_robocasa_residual_frontier_sweep_long_unattempted_probe.json', 'benchmark_robocasa_residual_frontier_sweep_longhorizon_gap_probe.json', 'benchmark_robocasa_residual_frontier_sweep_quick_close.json', 'benchmark_robocasa_residual_frontier_sweep_quick_gap.json']; triage_attempted_not_covered=34, triage_unattempted=226, triage_status_counts={'constructor_signature_failure': 11, 'micro_nondegenerate_covered': 4, 'not_implemented': 1, 'rollout_pool_covered': 132, 'timed_out': 11, 'unattempted': 226, 'value_error': 2, 'zero_distance_no_progress': 9})
