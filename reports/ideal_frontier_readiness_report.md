...
- `modern_vla_libero`: ready_to_promote=`False`; missing=['neural_visual_language_model_class', 'modern_vla_scale_or_pretrained_model']
  ...
  - neural_visual_language_model_class: `False` (policy_type='rgb_proprio_language_knn_behavior_cloning', is_neural=None)
  - modern_vla_scale_or_pretrained_model: `False` (pretrained_vla=None, vla_scale_parameters=None)
