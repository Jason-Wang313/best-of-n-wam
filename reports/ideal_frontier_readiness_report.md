...
- `full_robocasa_wide`: ready_to_promote=`False`; missing=['full_registry_rollout_pool_coverage', 'full_registry_any_artifact_coverage', 'all_categories_fully_covered']
  ...
  - full_registry_any_artifact_coverage: `False` (any_artifact_covered=136/396; residual_attempts=5, residual_candidates=10, residual_timeouts=9, residual_nondegenerate=0, residual_categories=['cleaning', 'close', 'long_horizon_or_compositional', 'manipulate', 'turn'], residual_artifacts=['benchmark_robocasa_residual_frontier_sweep_atomic_gap_probe.json', 'benchmark_robocasa_residual_frontier_sweep_cleaning_gap_probe.json', 'benchmark_robocasa_residual_frontier_sweep_longhorizon_gap_probe.json', 'benchmark_robocasa_residual_frontier_sweep_quick_close.json', 'benchmark_robocasa_residual_frontier_sweep_quick_gap.json']; triage_attempted_not_covered=32, triage_unattempted=228, triage_status_counts={'constructor_signature_failure': 11, 'micro_nondegenerate_covered': 4, 'not_implemented': 1, 'rollout_pool_covered': 132, 'timed_out': 9, 'unattempted': 228, 'value_error': 2, 'zero_distance_no_progress': 9})
...
- `maniskill_visual_ee`: ready_to_promote=`False`; missing=['rgb_or_rgbd_success', 'ee_control_success', 'pinocchio_available_for_ee']
  ...
  - pinocchio_available_for_ee: `False` (pinocchio_import=False, pinocchio_api=False, pypi_pinocchio_api=False, pypi_missing_symbols=['Model', 'GeometryModel', 'buildModelFromUrdf'], missing_symbols=['Model', 'GeometryModel', 'buildModelFromUrdf'])
