...
- task IDs covered by micro-rollout viability probes: `108`
- any-artifact task coverage: `136`
- any-artifact coverage fraction: `0.3434`

## Coverage By Category

- `cleaning`: rollout-pool `33`, micro-rollout `33`, any `33` / registered `35`
- `close`: rollout-pool `7`, micro-rollout `1`, any `8` / registered `13`
...
- `open`: rollout-pool `7`, micro-rollout `1`, any `8` / registered `13`
