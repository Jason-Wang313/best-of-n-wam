...
- Available: `True`.
- Verified: `True`.
- Policy type: `rbf_neural_vla_behavior_cloning`.
- Neural/action-head parameters: `846286`.
- Train action examples: `1265`.
- Heldout evaluation: `True`.
- Train/eval seed overlap: `[]`.
- Distillation teacher success rate: `None`.
- Neural train action MAE: `0.0010021146947295952`.
- Eval episodes: `1`.
- Eval successes: `1`.
